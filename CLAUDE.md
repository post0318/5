...
그라운딩 과금은 **월 5,000건 무료, 초과분 $14/1,000건**(= 건당 $0.014,
2026-09-21 공식 단가 확인). 주간 리포트는 회당 2~3콜이라 실제로는 무료
구간 안이지만, 예산 검사가 과소평가되지 않게 코드는 건당 $0.014 상한으로
잡는다(종전 $0.035 는 근거 없는 추정치였다). 검증 단계도 그라운딩 성공 여부로 갈린다 — 그라운딩이
