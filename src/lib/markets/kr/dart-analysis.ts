...
const C = {
  ...
  eps: { ids: ["ifrs-full_DilutedEarningsLossPerShare", "ifrs-full_BasicEarningsLossPerShare"], names: ["희석주당이익", "희석주당순이익", "기본주당이익", "기본주당순이익"] },
  ...
  ar: { ids: ["ifrs-full_CurrentTradeReceivables"], names: ["매출채권"] },
  inv: { ids: ["ifrs-full_Inventories"], names: ["재고자산"] },
  ap: { ids: ["ifrs-full_TradeAndOtherCurrentPayablesToTradeSuppliers"], names: ["매입채무"] },
