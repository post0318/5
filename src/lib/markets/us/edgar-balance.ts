...
const BLOCKS: { title: string; lines: Line[] }[] = [
  {
    ...
    lines: [
      ...
      { label: "기타 수취채권", concepts: ["NontradeReceivablesCurrent"], depth: 1 },
      { label: "재고자산", concepts: ["InventoryNet"], depth: 1 },
      { label: "기타 유동자산", concepts: ["OtherAssetsCurrent"], depth: 1 },
      { label: "기타 (유동자산)", depth: 1, plugOf: "cur" },
      { label: "유동자산 총계", depth: 0, kind: "subtotal", highlight: true, concepts: A_CUR },
      ...
      { label: "무형자산 (순)", concepts: ["IntangibleAssetsNetExcludingGoodwill", "FiniteLivedIntangibleAssetsNet"], depth: 1 },
      { label: "영업권", concepts: ["Goodwill"], depth: 1 },
      { label: "기타 비유동자산", concepts: ["OtherAssetsNoncurrent"], depth: 1 },
  ...
  },
  {
    ...
    lines: [
      ...
      { label: "유동부채 총계", depth: 0, kind: "subtotal", highlight: true, concepts: L_CUR },
